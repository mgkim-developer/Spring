...
> 그래서, _**JPA**_ 를 사용하면, 개발 생산성을 크게 높일 수 있습니다.     
>       
> ## JPA 
> 
...
>       
> ![image](https://user-images.githubusercontent.com/66030601/200481067-df26c2f4-f1c8-469e-8288-88d5fe53938d.png)     
> 우선, 제일 간단한 방법으로,      
> _**join()**_ 메서드의 실행시간을 측정해보겠습니다.      
>      
> <pre><code>System.currentTimeMillis();</code></pre>            
> 이것을 사용하면 밀리세컨드로 받을 수 있습니다.      
>        
> 그리고 로직이 끝날 때, 시간을 찍어야 하는데, 예외가 터져도 찍어야 하므로,     
> _**try-finally**_ 를 사용했습니다.     
>      
> 실행시간은 _**finish - start**_ 로 구해서 찍어주었습니다.      
>       
> 통합 테스트로 돌려보았더니,     
>       
> ![image](https://user-images.githubusercontent.com/66030601/200481528-5c485315-eed5-4000-85d8-c65d1854d18a.png)      
> 이렇게 찍힙니다.      
>      
> 모든 메서드의 실행시간을 측정해야 하므로, _**findMembers()**_ 에도 동일하게 작성해주겠습니다.      
>      
> ![image](https://user-images.githubusercontent.com/66030601/200481637-420d2cd4-d40f-4768-bc7d-f5daa17386cd.png)       
> 위와같이 작성해주었습니다.      
>       
> _**findMembers**_ 는 서버를 직접 돌려서 확인해보겠습니다.     
>      
> 서버를 돌리고, _**localhost:8080**_ 에서 회원 목록을 누르면,     
> 로그에 _**findMembers**_ 의 실행시간이 찍힐 것입니다.       
>        
> ![image](https://user-images.githubusercontent.com/66030601/200481797-6211a3f1-6ed7-412c-8a55-e21cbdecc2d1.png)        
> 이렇게 찍혔습니다.     
> 두번째 돌리니까 속도가 조금 빨라졌습니다. (처음에 올리면 클래스 메타데이터 등등을 로딩하는라 좀더 오래 걸립니다.)     
>       
> 이렇게 작성하면 여러가지 문제가 있습니다.      
>       
> ![image](https://user-images.githubusercontent.com/66030601/200482006-c258b08d-a394-4265-8b52-e4f5da23a83c.png)        
> ### 문제    
> - 회원 가입, 회원 조회에 시간을 측정하는 기능은 핵심 관심사항이 아닙니다.       
...
>              
> 따라서 이러한 상황에는 _**AOP**_ 를 적용해서     
> 공통 관심 사항(cross-cutting concern)과 핵심 관심 사항(core concern)을 분리해줘야 합니다.
>
> ***         
>       
